    ...
    <body>
        <header>
            ...
            <div class="row">
                <nav id="navUsers" class="col s10 offset-m2 centered tabs z-depth-0">
                    <ul class="tabs">
                        <li  onClick="embed('pagina_inicial.jsp')"><a class="tab"><img src="../img/Icons/icones/png/home-1.png" 
                                                                    alt="Página Inicial" title="Página Inicial"></a></li>

                        <!--Perfil do Usuário-->
                        <li onclick="embed('alterar_perfil.jsp')"><a class="tab"><img src="../img/Icons/icones/png/edit.png" 
                                             alt="Alterar Perfil" title="Visualizar Perfil"></a></li>

                        <!--Caixa de Mensagens-->
                        <li onclick="embed('../errors/manutencao.jsp')"> <a class="tab"><img src="../img/Icons/icones/png/folder-14.png" 
                                              alt="Caixa de Mensagens" title="Caixa de Mensagens"></a></li>

                        <!--Postagens e Notícias Recentes-->
                        <li onclick="embed('../errors/manutencao.jsp')">  <a class="tab"><img src="../img/Icons/icones/png/newspaper.png" 
                                               alt="Divulgações Recentes" title="Divulgações Recentes"></a></li>

                        <!--Oportunidade de Estágios-->
                        <li onclick="embed('alterar_perfil.jsp')">  <a class="tab"><img src="../img/Icons/icones/png/briefcase.png" 
                                               alt="Estágio" title="Oportunidades de Estágio"></a></li>

                        <!--Cursos Extra-curriculares-->
                        <li onclick="embed('../errors/manutencao.jsp')"><a class="tab"><img src="../img/Icons/icones/png/notepad-2.png" 
                                             alt="Cursos" title="Cursos Disponíveis"></a></li>

                        <!--Currículo do Aluno-->
                        <li onclick="embed('../errors/manutencao.jsp')">  <a class="tab" ><img src="../img/Icons/icones/png/diploma.png" 
                                               alt="Meu Currículo" title="Meu Currículo"></a></li>

                        <!--Voltar para Página de Login-->
                        <li onclick="embed('../home.jsp')"> <a class="tab"><img src="../img/Icons/icones/png/exit-1.png" 
                                                      alt="Sair" title="Sair para página de Login"></a></li>
                    </ul>
                </nav>
                ...
                <div id="embedPai" class="col s10 z-depth-0">
                    <embed id="embed" src="pagina_inicial.jsp" class="col s12 offset-x30">
                </div>
        ...
        <script>
            function embed(src){
                $("#embed").remove();
                $("#embedPai").append('<embed id="embed" src="'+src+'" class="col s12 offset-x30">');
            }
        </script>
    </body>
</html> --%>